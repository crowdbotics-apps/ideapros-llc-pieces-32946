...
## Project Structure
    ...
    ├── ideapros_llc_pieces_32946  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_pieces_32946`
...
2. Clone this repo and `cd ideapros_llc_pieces_32946`
